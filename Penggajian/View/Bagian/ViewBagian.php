...
<table id="myTable" class="table table-striped  table-hover" >
	...
	?>
		<tr>
			...
			<td><a class="ajax-action-links" href="indexbagian.php?kode_bagian=<?php echo $row['kode_bagian']?>&get=true"><img src="crud-icon/edit.png" title="Update" /></a> <a class="ajax-action-links" href="indexbagian.php?kode_bagian=<?php echo $row['kode_bagian']?>&delete=true"><img src="crud-icon/delete.png" title="Delete" /></a></td>
		</tr>
		<?php } ?>
	</tbody>
</table></div>
