...
<form name="frmAdd" action="indexkaryawan.php?save=true" method="POST">
  ...
  <div class="demo-form-row">
    ...
    <select  name="kode_jabatan" class="demo-form-field" required><?php $sql = "select * from jabatan";
  ...
  <div class="demo-form-row">
    ...
    <select  name="kode_bagian" class="demo-form-field" required><?php $sql = "select * from bagian";
    $result = mysqli_query($con,$sql);
    if(mysqli_num_rows($result)!=''){ while ($data = mysqli_fetch_array($result,MYSQLI_NUM)) {
      ?>
  ...
  <div class="demo-form-row">
    ...
    <select  name="kode_golongan" class="demo-form-field" required><?php $sql = "select * from Golongan";
    $result = mysqli_query($con,$sql);
    if(mysqli_num_rows($result)!=''){ while ($data = mysqli_fetch_array($result,MYSQLI_NUM)) {
      ?>
